...
public class IMInformeIncidenciasFicheros extends IMReportRoot {

	private static final Logger	logger	= LoggerFactory.getLogger(IMInformeIncidenciasFicheros.class);

	public IMInformeIncidenciasFicheros() {
		super("EInformeIncidenciasFicheros", "informe_incidencias_ficheros");
		HashMap<String, String> mEntityReport = new HashMap<String, String>();
		this.setDateTags(new TimeStampDateTags("F_ALTA"));
		mEntityReport.put("informe_incidencias_ficheros", "EInformeIncidenciasFicheros");
	...
	public void registerInteractionManager(Form f, IFormManager gf) {
		...
		bt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionevent) {
				IMInformeIncidenciasFicheros.this.createReports();
			}
		});
	...
	public void setInitialState() {
		...
		try {
			...
			MessageManager.getMessageManager().showExceptionMessage(ex, IMInformeIncidenciasFicheros.logger);
		}
	}
	...
	private void createReports() {
		...
		final JRReportDescriptor jrd = jpm.getDataMap().get(46);
			...
			try {
				...
				OperationThread opth = new OperationThread() {
					...
					public void run() {
						...
						JasperPrint jp = null;
						try {
							Table tb = (Table) IMInformeIncidenciasFicheros.this.managedForm.getElementReference("EInformeIncidenciasFicheros");
