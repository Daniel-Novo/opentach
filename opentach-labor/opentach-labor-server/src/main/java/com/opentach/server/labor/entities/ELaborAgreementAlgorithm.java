...
public class ELaborAgreementAlgorithm extends OracleTableEntity {

	public ELaborAgreementAlgorithm(EntityReferenceLocator b, DatabaseConnectionManager g, int p) throws Exception {
		super(b, g, p);
	}
	...
	private EntityResult createResponse() {
		List<String> agreementAlgorithmImplementations = ((UReferenceSeeker) this.locator).getService(LaborAgreementsService.class).getAgreementAlgorithmImplementations();
