...
@XmlSeeAlso({
    WebResultOfString.class,
    WebResultOfListOfTachoFileInfo.class,
    WebResultOfTachoScheduleInfo.class,
    WebResultOfTachoDownloadInfo.class,
    WebResultOfListOfGPSPositionInfo.class
})
