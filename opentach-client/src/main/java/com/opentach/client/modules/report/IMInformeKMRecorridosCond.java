...
public class IMInformeKMRecorridosCond extends IMReportRoot {

	public IMInformeKMRecorridosCond() {
	...
	public void registerInteractionManager(Form f, IFormManager gf) {
		...
		bt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionevent) {
				IMInformeKMRecorridosCond.this.createReports();
			}
		});
	}
	...
	protected void createReports() {
		...
		final Map<String, Object> params = this.getParams("informe_km_cond", "iddelegacion");
		...
		try {
			final String urljr = "com/opentach/reports/kmrecorridoscond.jasper";
			JRPropertyManager jpm = new JRPropertyManager("com/opentach/reports/reports.properties");
			final JRReportDescriptor jrd = jpm.getDataMap().get(41);
			OperationThread opth = new OperationThread() {
				...
				public void run() {
					...
					JasperPrint jp = null;
					try {
						Table tb = (Table) IMInformeKMRecorridosCond.this.managedForm.getElementReference("EInformeUsoTarjeta");
