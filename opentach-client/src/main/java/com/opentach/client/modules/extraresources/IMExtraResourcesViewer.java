package com.opentach.client.modules.extraresources;
...
public class IMExtraResourcesViewer extends UBasicFIM {

	private static final Logger	logger		= LoggerFactory.getLogger(IMExtraResourcesViewer.class);
