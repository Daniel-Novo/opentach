...
public class IMInformePendDescargaAgente extends IMReportRoot {

	public IMInformePendDescargaAgente() {
		super("EInformePendDescargaAgente", "informe_pend_descarga_agente");
		HashMap<String, String> mEntityReport = new HashMap<String, String>();
		this.setDateTags(new TimeStampDateTags("F_DESCARGA_DATOS"));
		mEntityReport.put("informe_pend_descarga_agente", "EInformePendDescargaAgente");
	...
	public void registerInteractionManager(Form f, IFormManager gf) {
		...
		bt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionevent) {
				IMInformePendDescargaAgente.this.createReports();
			}
		});
	...
	private void createReports() {
		...
		final JRReportDescriptor jrd = jpm.getDataMap().get(52);
			...
			try {
				...
				OperationThread opth = new OperationThread() {
					...
					public void run() {
						...
						JasperPrint jp = null;
						try {
							Table tb = (Table) IMInformePendDescargaAgente.this.managedForm.getElementReference("EInformePendDescargaAgente");
