			...
			try {
				...
				if (categoryName != null) {
					...
					Serializable idParentCategory = DocumentationTreePopupMenuManager.this.currentPopupCategory == null ? null : DocumentationTreePopupMenuManager.this.currentPopupCategory
							.getIdCategory();
					Serializable idCategory = DocumentationTreePopupMenuManager.this.getDMSService().categoryInsert(idDocument, categoryName, idParentCategory, null,
							DocumentationTreePopupMenuManager.this.getSessionId());
	...
	protected class DeleteCategoryAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				...
				DocumentationTreePopupMenuManager.this.getDMSService().categoryDelete(DocumentationTreePopupMenuManager.this.currentPopupCategory.getIdCategory(),
						DocumentationTreePopupMenuManager.this.getSessionId());
