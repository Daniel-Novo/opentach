								...
								if (rtn == JOptionPane.YES_OPTION) {
									OperationThread infoInforme = new OperationThread("Eliminando_contrato") {
										...
										public void run() {
											try {
												this.hasStarted = true;
												IContractService contractService = ((OpentachClientLocator) IMEliminarContrato.this
								...
								OperationThread infoInforme = new OperationThread(ApplicationManager.getTranslation("Reprocesando_contrato")) {
									...
									public void run() {
										try {
											...
											IContractService contractService = ((OpentachClientLocator) IMEliminarContrato.this.getReferenceLocator())
