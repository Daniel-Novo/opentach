 ...
 *         &lt;element name="firstDayOfMonth" type="{http://www.w3.org/2001/XMLSchema}boolean"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "setTachoScheduleForVehicle")
public class SetTachoScheduleForVehicle {

    @XmlElement(name = "CIF")
    protected String cif;
    protected String numberPlate;
    protected boolean firstDayOfMonth;
    ...
    /**
     * Obtiene el valor de la propiedad firstDayOfMonth.
     * 
     */
    ...
    /**
     * Define el valor de la propiedad firstDayOfMonth.
     * 
     */
    public void setFirstDayOfMonth(boolean value) {
