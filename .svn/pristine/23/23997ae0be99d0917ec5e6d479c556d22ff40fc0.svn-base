...
public class IMInformePendDescargaFull extends IMReportRoot {

	private static final Logger	logger	= LoggerFactory.getLogger(IMInformePendDescargaFull.class);

	public IMInformePendDescargaFull() {
		super("EInformePendDescarga", "informe_pend_descarga_full");
		HashMap<String, String> mEntityReport = new HashMap<String, String>();
		this.setDateTags(new TimeStampDateTags("F_DESCARGA_DATOS"));
		mEntityReport.put("informe_pend_descarga_full", "EInformePendDescarga");
	...
	public void registerInteractionManager(Form f, IFormManager gf) {
		...
		bt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionevent) {
				IMInformePendDescargaFull.this.createReports();
			}
		});
	...
	public void setInitialState() {
		...
		try {
			...
			MessageManager.getMessageManager().showExceptionMessage(ex, IMInformePendDescargaFull.logger);
		}
	}
			...
			try {
				...
				OperationThread opth = new OperationThread() {
					...
					public void run() {
						...
						JasperPrint jp = null;
						try {
							Table tb = (Table) IMInformePendDescargaFull.this.managedForm.getElementReference("EInformePendDescarga");
