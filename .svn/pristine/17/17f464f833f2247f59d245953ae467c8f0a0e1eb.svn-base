...
public class EConductoresCAP extends OracleTableEntity {

	private static final Logger	logger	= LoggerFactory.getLogger(EIncidentes.class);

	public EConductoresCAP(EntityReferenceLocator b, DatabaseConnectionManager g, int p) throws Exception {
		super(b, g, p);
	}
	...
	public EntityResult insert(Hashtable attributesValues, int sessionId, Connection con) throws Exception {
		attributesValues.put("IS_MINISTERIO", "N");
