...
@XmlRootElement(name = "sendMailDOT")
public class SendMailDOT {

    @XmlElementRef(name = "recipientEmail", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> recipientEmail;

    /**
     * Obtiene el valor de la propiedad recipientEmail.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Define el valor de la propiedad recipientEmail.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
