...
"%mypath%maven/bin/mvn.bat" -o clean install -Ppre-pro,generate-jnlp,italy -Dmaven.test.skip=true -DskipTests=true -s %SETTINGS_XML% -Dmaven.repo.local=%REPO_HOME%