...
public class IMInformeFicherosTamano extends IMReportRoot {

	public IMInformeFicherosTamano() {
		super("EInformeFicherosTamano", "informe_ficheros_tamano");
		HashMap<String, String> mEntityReport = new HashMap<String, String>();
		this.setDateTags(new TimeStampDateTags("F_DESCARGA_DATOS"));
		mEntityReport.put("informe_ficheros_tamano", "EInformeFicherosTamano");
	...
	public void registerInteractionManager(Form f, IFormManager gf) {
		...
		bt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionevent) {
				IMInformeFicherosTamano.this.createReports();
			}
		});
	...
	private void createReports() {
		...
		final JRReportDescriptor jrd = jpm.getDataMap().get(58);
			...
			try {
				...
				OperationThread opth = new OperationThread() {
					...
					public void run() {
						...
						JasperPrint jp = null;
						try {
							Table tb = (Table) IMInformeFicherosTamano.this.managedForm.getElementReference("EInformeFicherosTamano");
