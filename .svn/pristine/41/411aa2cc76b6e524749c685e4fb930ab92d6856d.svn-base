...
public class IMInformeDriversNotDownloading extends IMReportRoot {


	public IMInformeDriversNotDownloading() {
		super("EInformeDriversNotDownloading", "informe_Drivers_not_downloading");
