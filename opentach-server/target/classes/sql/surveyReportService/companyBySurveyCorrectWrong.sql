SELECT
    (case when LENGTH(s_correct_wrong.survey_name) > 12 then SUBSTR(s_correct_wrong.survey_name,0,12)||'...' else s_correct_wrong.survey_name end) as XAXIS, 
...
WHERE
 ...
 order by s_correct_wrong.survey_name, s_correct_wrong.SERIE asc